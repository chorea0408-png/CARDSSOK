...
// ── 하단 배너 광고 ────────────────────────────────────────────────────
// 배포 & 애드센스 승인 후 주석 처리된 <ins> 태그를 활성화하고
...
const BottomAdBanner: React.FC = () => {
  ...
  return (
    <div className="relative flex items-center justify-center bg-gray-100 border-t border-gray-200 shrink-0" style={{ height: 90 }}>
      ...
      {/* 플레이스홀더 */}
      <div className="flex items-center gap-3 border-2 border-dashed border-gray-300 rounded-lg px-8 text-gray-300" style={{ width: 728, height: 70 }}>
        <span className="text-xl">📢</span>
        <p className="text-sm">하단 배너 광고 (728 × 90) — 배포 후 애드센스 코드 삽입</p>
      </div>
